...
def RTScan_3c_unique_1e8():
    ...
    os.system(
        f'make rtscan DATA_N=1e8 VAREA_N=96 DEBUG_ISHIT_CMP_RAY=0 DEBUG_INFO=0 DISTRIBUTION=0 ENCODE=0 BUILD_TYPE=Release')
...
def RTScan_3c_skewed(encode=1):
    ...
    os.system('make clean')
    os.system(f'make rtscan DATA_N=1e8 VAREA_N=96 DEBUG_ISHIT_CMP_RAY=0 DEBUG_INFO=0 DISTRIBUTION=0 ENCODE={encode} BUILD_TYPE=Release')
